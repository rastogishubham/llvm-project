...
; DEBUG-NEXT:    tail call void @llvm.dbg.value(metadata i16 [[A_SROA_2_0_EXTRACT_TRUNC:%.*]], metadata [[META258]], metadata !DIExpression(DW_OP_LLVM_fragment, 16, 16)), !dbg !263
...
; DEBUG-NEXT:    tail call void @llvm.dbg.value(metadata ptr undef, metadata [[META282:![0-9]+]], metadata !DIExpression()), !dbg [[DBG291:![0-9]+]]
...
; DEBUG-NEXT:    tail call void @llvm.dbg.value(metadata ptr %x.sroa.0, metadata [[META397:![0-9]+]], metadata !DIExpression()), !dbg [[DBG403]]
...
; DEBUG-NEXT:    tail call void @llvm.dbg.value(metadata ptr %x.sroa.0, metadata [[META432:![0-9]+]], metadata !DIExpression()), !dbg [[DBG437]]
...
; DEBUG-NEXT:    tail call void @llvm.dbg.value(metadata ptr %a.sroa.0, metadata [[META449:![0-9]+]], metadata !DIExpression()), !dbg [[DBG452]]
...
; DEBUG-NEXT:    tail call void @llvm.dbg.value(metadata i64 [[TMP_SROA_0_0_COPYLOAD:%.*]], metadata [[META458:![0-9]+]], metadata !DIExpression()), !dbg [[DBG60:![0-9]+]]
...
; DEBUG-NEXT:    tail call void @llvm.dbg.value(metadata ptr undef, metadata [[META58:![0-9]+]], metadata !DIExpression()), !dbg [[DBG515:![0-9]+]]
...
; DEBUG-NEXT:  entry:
; DEBUG-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META556:![0-9]+]], metadata !DIExpression()), !dbg [[DBG560:![0-9]+]]
; DEBUG-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META557:![0-9]+]], metadata !DIExpression()), !dbg [[DBG561:![0-9]+]]
...
; DEBUG-NEXT:    call void @llvm.dbg.value(metadata ptr undef, metadata [[META558:![0-9]+]], metadata !DIExpression()), !dbg [[DBG563:![0-9]+]]
; DEBUG-NEXT:    [[TMP0:%.*]] = bitcast <2 x i64> [[COND_SROA_0_8_VEC_INSERT]] to <4 x i32>, !dbg [[DBG564:![0-9]+]]
; DEBUG-NEXT:    call void @llvm.dbg.value(metadata <4 x i32> [[TMP0]], metadata [[META559:![0-9]+]], metadata !DIExpression()), !dbg [[DBG564]]
